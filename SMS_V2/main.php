...
<html>
    ...
    <body>       
        ...
        <div class="en" lang="en">
            <div class="tab">
                <button class="tablinks active" data-target="home"><img src="img/icon/home.png" alt="Home" width="35" height="35">&nbsp; Home </button>
                <button class="tablinks" data-target="campus"><img src="img/icon/campus.png" alt="Campus area" width="35" height="35">&nbsp; Campus area</button>
                <button class="tablinks" data-target="school"><img src="img/icon/schoolCenter.png" alt="School Centre" width="35" height="35">&nbsp; Learning Centre</button>
                <button class="tablinks" data-target="teacher"><img src="img/icon/class.png" alt="Teacher workshop" width="35" height="35">&nbsp; Teacher Work Place</button>
                <button class="tablinks" data-target="admin"><img src="img/icon/admin.png" alt="Administration" width="35" height="35">&nbsp; Admin Management</button>

                <div class="profile">
                    <button class="tablinks" data-target="profile"><img src="img/icon/profile.png" alt="Profile" width="35" height="35">&nbsp; Profile</button>
                    <button class="tablinks" data-target="logout" onclick="logout()"><img src="img/icon/logout.png" alt="Logout" width="35" height="35" >&nbsp; Logout</button>
                </div>
            </div>
        </div>
        ...
        <div class="zh" lang="zh">
            <div class="tab">
                <button class="tablinks active" data-target="home"><img src="img/icon/home.png" alt="Home" width="35" height="35">&nbsp; 主頁 </button>
                <button class="tablinks" data-target="campus"><img src="img/icon/campus.png" alt="Campus area" width="35" height="35">&nbsp; 校園地帶</button>
                <button class="tablinks" data-target="school"><img src="img/icon/schoolCenter.png" alt="School Centre" width="35" height="35">&nbsp; 學習中心</button>
                <button class="tablinks" data-target="teacher"><img src="img/icon/class.png" alt="Teacher workshop" width="35" height="35">&nbsp; 老師工作間</button>
                <button class="tablinks" data-target="admin"><img src="img/icon/admin.png" alt="Administration" width="35" height="35">&nbsp; 行政管理</button>

                <div class="profile">
                    <button class="tablinks" data-target="profile"><img src="img/icon/profile.png" alt="Profile" width="35" height="35">&nbsp; 個人</button>
                    <button class="tablinks" data-target="logout" onclick="logout()" ><img src="img/icon/logout.png" alt="Logout" width="35" height="35" >&nbsp; 登出</button>
                </div>
            </div>
        </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    ...
                                    <p><a href="# " class="en" lang="en">Book Search</a>
                                        <a href="# " class="zh" lang="zh">尋找圖書</a>  </p>
                    ...
                    <td class="menu">
                        ...
                        <div class="accordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="# " class="en" lang="en">Add User</a>
                                    <a href="# " class="zh" lang="zh">添加用戶</a>  
                                    <p><a href="# " class="en" lang="en">List User</a>
                                        <a href="# " class="zh" lang="zh">列出用戶</a>  </p>
